...
function update() {
  ...
  _mesh[0].material.color = color.lerp(new THREE.Color(Math.random(), Math.random(), Math.random()), _noise * 30)
  _mesh[1].material.color = color.lerp(new THREE.Color(Math.random(), Math.random(), Math.random()), _noise * 30)
  _mesh[2].material.color = color.lerp(new THREE.Color(Math.random(), Math.random(), Math.random()), _noise * 30)

  if (_noise >= 0.0001) {
    if (_cnt % 4 == 0) {
      // alternate between true and false
      _mesh[0].material.wireframe = !_mesh[0].material.wireframe
      _mesh[1].material.wireframe = !_mesh[1].material.wireframe
      _mesh[2].material.wireframe = !_mesh[2].material.wireframe
    }
  } else {
    _mesh[0].material.wireframe = false
    _mesh[1].material.wireframe = false
    _mesh[2].material.wireframe = false
  }
