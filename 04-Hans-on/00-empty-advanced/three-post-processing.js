class PostProcessing {
  constructor(renderer, parameter, resolutionRatio) {
    ...
    this.resolution.multiplyScalar(
      this.renderer.getPixelRatio() * (this.resolutionRatio ? this.resolutionRatio : 1.0),
    )
  ...
  render(
    scene_srcTexture_offScreen = false,
    camera_offScreenRendering = false,
